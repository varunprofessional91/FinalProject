...
<div>
    ...
    <div style="background-color:white; margin-left:auto;margin-right:auto; border-radius:5px; border:1px solid; border-color: rgb(78,105,143); position:absolute; align-content:center; top:100px; left:300px; width:700px;height:440px;text-align:center;padding:10px 20px 30px 20px; opacity:0.7;">
        <div style="background-color:rgb(1,168,123); margin:0px; top:0; left:0; width:100%; height:30px; position:absolute;">
            <p style="font-family: calibri; text-align: center; margin:5px; color:white; font-size:15px;">Debit or Credit Amount</p>
...
<br>
            ...
            <form action="Transactions1" method="post">

                <p>Acc No.      : <input type="text" id="text1" name="accno"><br></p>

                <p>Amount    : <input type="text" id="text4" name="amt" ><br></p>
                <p>Transfer  : <select id="sel1" name="transactions">
                    <option selected value="credit">Deposit Amount</option>
                    <option value="debit">Withdrawl Amount</option>
                </select><br></p>
